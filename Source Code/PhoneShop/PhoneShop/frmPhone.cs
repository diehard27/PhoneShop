    ...
    public partial class frmPhone : Form
    {
       ...
       string currID;
        ...
        private void frmPhone_Load(object sender, EventArgs e)
        {
            ...
            //------------fill dataset
            da.SelectCommand = new MySqlCommand("select * from Phone", conn);
            try
            {
                da.Fill(ds, "Phone");
            }
            ...
            //-------------add datatable
            dt = ds.Tables["Phone"];
            dt.DefaultView.Sort = "Phone_ID";

            //-------------binding control
            cm = (CurrencyManager)this.BindingContext[dt];
            dg.DataSource = dt;
            txtID.DataBindings.Add("Text", dt, "Phone_ID");
            txtName.DataBindings.Add("Text", dt, "Phone_Brand");
            txtModel.DataBindings.Add("Text", dt, "Phone_Model");
            txtColor.DataBindings.Add("Text", dt, "Phone_Color");
            txtSpec.DataBindings.Add("Text", dt, "Phone_Spec");
            txtPrice.DataBindings.Add("Text", dt, "Phone_Price");
